...
#ifndef TSPDPROBLEM_DT_H_
#define TSPDPROBLEM_DT_H_

#include <vector>
#include <string>
using namespace std;

class Tspd_problem_dt
{
private:
public:
	...
	Tspd_problem_dt(const std::string& filename);
	virtual ~Tspd_problem_dt();
