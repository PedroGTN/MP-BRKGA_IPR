...
with open(csv_file_name, 'w') as csv, open (csv_avg_file_name, 'w') as csv_avg:
    csv_avg.write('instance_name,num_nodes,instance_type,alpha,total_runtime,optimal_tsp_solution,optimal_tsp_split,lkh_cost,lkh_split,best_solution_cost,opt_to_best_dist,opt_to_best_percent,optsplit_to_best_dist,optsplit_to_best_percent\n')
                ...
                for i in num_list:
                    for s in solutions:
                        ...
                        with open(sol_path) as sol, open(tsp_solution, 'w') as tspsol:
                            ...
                            tspsol.write(sol_lines[8].split(':')[2][1:])
                            ...
                            csv.write(("{:.4f},".format(float(sol_lines[5].split(':')[2].strip()))))
                            ...
                            lkh_avg += float(sol_lines[5].split(':')[2].strip())
